 ...
 * */
class FetchTweets_Template_Settings_Sample extends FetchTweets_Template_Settings_Sample_ {

	/*
	 * Modify these properties.
	 * */
	protected $strParentPageSlug = 'fetch_tweets_templates';	// in the url, the ... part of ?page=... 
	protected $strParentTabSlug = 'sample';	// in the url, the ... part of &tab=...
	protected $strTemplateName = 'Sample';	// the template name
	...
	public function addSettingSections( $arrSections ) {
		...
		$arrSections[] = array(
			'strSectionID'		=> 'fetch_tweets_template_sample',
	...
	public function addSettingFields( $arrFields ) {
		...
		$intWidth = isset( $arrOptions[ $this->strParentPageSlug ]['fetch_tweets_template_sample']['fetch_tweets_template_sample_width'] )
			? $arrOptions[ $this->strParentPageSlug ]['fetch_tweets_template_sample']['fetch_tweets_template_sample_width']
			: 100;	// default
		$intHeight = isset( $arrOptions[ $this->strParentPageSlug ]['fetch_tweets_template_sample']['fetch_tweets_template_sample_height'] )
			? $arrOptions[ $this->strParentPageSlug ]['fetch_tweets_template_sample']['fetch_tweets_template_sample_height']
			: 800;	// default
		
		$arrFields[] = array(
			'strFieldID' => 'fetch_tweets_template_sample_avatar_size',
			'strSectionID' => 'fetch_tweets_template_sample',
		...
		$arrFields[] = array(
			'strFieldID' => 'fetch_tweets_template_sample_width_unit',
			'strSectionID' => 'fetch_tweets_template_sample',
			...
			'vDefault' => '%',
			'vBeforeInputTag' => '<span id="fetch_tweets_template_sample_fetch_tweets_template_sample_width"><input id="fetch_tweets_template_sample_fetch_tweets_template_sample_width_0" class="" size="30" type="number" name="fetch_tweets_admin[fetch_tweets_templates][fetch_tweets_template_sample][fetch_tweets_template_sample_width]" value="' .  $intWidth . '" min="" max="" step="" maxlength=""></span>',
		);
		$arrFields[] = array(
			'strFieldID' => 'fetch_tweets_template_sample_height_unit',
			'strSectionID' => 'fetch_tweets_template_sample',
			...
			'vDefault' => 'px',
			'vBeforeInputTag' => '<span id="fetch_tweets_template_sample_fetch_tweets_template_sample_height"><input id="fetch_tweets_template_sample_fetch_tweets_template_sample_height_0" class="" size="30" type="number" name="fetch_tweets_admin[fetch_tweets_templates][fetch_tweets_template_sample][fetch_tweets_template_sample_height]" value="' .  $intHeight . '" min="" max="" step="" maxlength=""></span>',
		);
		$arrFields[] = array(  // single button
			'strFieldID' => 'fetch_tweets_template_sample_submit',
			'strSectionID' => 'fetch_tweets_template_sample',
			'strType' => 'submit',
...
new FetchTweets_Template_Settings_Sample;


/*
 * No need to modify the following class.
 * */
abstract class FetchTweets_Template_Settings_Sample_ {
